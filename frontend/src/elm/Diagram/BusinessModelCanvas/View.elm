module Diagram.BusinessModelCanvas.View exposing (docs, view)

import Constants
import Diagram.BusinessModelCanvas.Types as BusinessModelCanvas exposing (BusinessModelCanvasItem(..))
