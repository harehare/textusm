module Views.Icon exposing (add, download, error, export, file, folderOpen, fullscreen, fullscreenExit, indent, info, openInNew, remove, save, settings, share, warning)
